...
const PROMPT_TEXT = `Generate a fully tailored, ATS-optimized, and professionally written resume based on my career milestones and the provided job description. Give me Text-only version result that I can copy and paste in my document meaning that this is reasume-ready version. Do not provide any additional info like code-block or quote.
...
export default function Home() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const response = await fetch("https://pdf-builder-backend-8rtb.onrender.com/scrape-qwen", {
        method: "POST",
        headers: {
